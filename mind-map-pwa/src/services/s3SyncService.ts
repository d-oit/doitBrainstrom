...
// Only initialize S3 if all required environment variables are present
const initializeS3 = () => {
  if (
...
const isS3Enabled = initializeS3();

// Then use isS3Enabled to conditionally execute S3-related code
if (isS3Enabled) {
